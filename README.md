...
4. Create an `.env` and fill in your values
   ...
   | `INFLUXDB_URL`                         | The URL of the InfluxDB to write to. When running via `compose.yaml` this is set by the app container and must NOT be put into the `.env`, since the `.env` takes precedence over the environment.                                                                                                                            | -                            | A URL. Example: `http://influxdb:8086`                                                                                       |
