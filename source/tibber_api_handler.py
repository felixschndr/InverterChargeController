...
class TibberAPIHandler(LoggerMixin):
    ...
    def get_next_price_minimum(
        ...
        Without this threshold, these values would be interpreted as maximums (which they are not).
    ...
    def set_maximum_charging_duration_of_current_energy_rate(
        ...
        current_energy_rate.maximum_charging_duration = (
            upcoming_energy_rate.timestamp - current_energy_rate.timestamp + timedelta(hours=1)
        )
