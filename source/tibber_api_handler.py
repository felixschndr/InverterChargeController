...
class TibberAPIHandler(LoggerMixin):
    ...
    def get_upcoming_energy_rates(self) -> list[EnergyRate]:
        ...
        self.log.info(f"The energy rates are in 15 minute tacts: {self.energy_rates_are_in_15_minute_tacts}")
    ...
    def set_maximum_charging_duration_of_current_energy_rate(
        ...
        cheap_energy_duration = (upcoming_energy_rate.timestamp - current_energy_rate.timestamp) + timedelta(hours=1)
