...
4. Create an `.env` and fill in your values
   ...
   |-------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
   | `DRY_RUN`                                                                                       | Do not actually change the operation mode of the inverter (for testing purposes).                                                                                                                                                                                                   | `True`                                  | [`True`, `False`]                                                                                                            |
   ...
   | `ENVIRONMENT`                                                                                   | Appends the given string to the name of all logfiles, can be used to have multiple instances of this software running at the same time and log to different files. E.g. `"ENVIRONMENT="prod"`: `app.log` becomes `app_prod.log`.                                                    | `<empty string>`                        | A string, example: `prod`                                                                                                    |
   ...
   | `LOCATION_LATITUDE`                                                                             | See https://doc.forecast.solar/api:estimate#url_parameters for an explanation.                                                                                                                                                                                                      | -                                       | A string, example: `48.8778244909298`                                                                                        |
   | `LOCATION_LONGITUDE`                                                                            | See https://doc.forecast.solar/api:estimate#url_parameters for an explanation.                                                                                                                                                                                                      | -                                       | A string, example: `2.3321814528287352`                                                                                      |
   | `LOCATION_HEIGHT`                                                                               | The height of your property relative to sea level (only used for sunrise and sunset calculation, not that important).                                                                                                                                                               | `0`                                     | A number greater or equal to `0`                                                                                             |
   | `PANELS_PACK2_INSTALLED`                                                                        | Whether there is a second solar array installed. This can be used if you have solar panels on both sides of your roof or a small balcony power plant. If this set to `True` you have to set all the `...PACK2...` values.                                                           | `False`                                 | [`True`, `False`]                                                                                                            |
   | `PANELS_PACK1_PLANE_DECLINATION` and `PANELS_PACK2_PLANE_DECLINATION`                           | See https://doc.forecast.solar/api:estimate#url_parameters for an explanation.                                                                                                                                                                                                      | -                                       | A number between `0` and `90`                                                                                                |
   | `PANELS_PACK1_PLANE_AZIMUTH` and `PANELS_PACK2_PLANE_AZIMUTH`                                   | See https://doc.forecast.solar/api:estimate#url_parameters for an explanation.                                                                                                                                                                                                      | -                                       | A number between `-180` and `180`                                                                                            |
   | `PANELS_PACK1_NUMBER_OF_PANELS` and `PANELS_PACK2_NUMBER_OF_PANELS`                             | The number of installed solar panels.                                                                                                                                                                                                                                               | -                                       | A number, typically between `5` and `50`.                                                                                    |
   | `PANELS_PACK1_MAXIMUM_POWER_OUTPUT_PER_PANEL` and `PANELS_PACK2_MAXIMUM_POWER_OUTPUT_PER_PANEL` | The maximum power output per solar panel in watts.                                                                                                                                                                                                                                  | -                                       | A number, typically between `100` and `600`.                                                                                 |
